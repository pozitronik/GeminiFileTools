...
type
  ...
  IGeminiFileParser = interface
    ...
    function Parse(AStream: TStream; ARunSettings: TGeminiRunSettings;
      AChunks: TObjectList<TGeminiChunk>): string;
  end;
  ...
  private
    ...
    procedure ParsePartsInto(AArr: TJSONArray; AChunkIndex: Integer;
      AParts: TObjectList<TGeminiPart>);
...
function TGeminiFileParser.Parse(AStream: TStream; ARunSettings: TGeminiRunSettings;
  AChunks: TObjectList<TGeminiChunk>): string;
var
  LBytes: TBytes;
  LJsonStr: string;
...
procedure TGeminiFileParser.ParsePartsInto(AArr: TJSONArray; AChunkIndex: Integer;
  AParts: TObjectList<TGeminiPart>);
var
  I: Integer;
