...
type
  ...
  public
    ...
    constructor Create(AParser: IGeminiFileParser = nil;
      AExtractor: IGeminiResourceExtractor = nil);
    ...
    property OnExtractProgress: GeminiFile.Types.TGeminiExtractProgressEvent
      read FOnExtractProgress write FOnExtractProgress;
  end;
...
constructor TGeminiFile.Create(AParser: IGeminiFileParser;
  AExtractor: IGeminiResourceExtractor);
begin
  inherited Create;
...
begin
  Result := FExtractor.ExtractAll(GetResources, AOutputDir, AThreaded,
    ANamePrefix, FOnExtractProgress);
end;
